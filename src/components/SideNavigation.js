...
export default class SideNavigation extends Component {
    ...
    render() {
        return (
            <nav id="sideNav" style={{ display: window.innerWidth < 992 ? 'none' : 'block', position: 'fixed', top: '50%', opacity: 0, right: '0px', transform: 'translateY(-50%)', zIndex: '9', userSelect: 'none', }}>
                <div style={{
